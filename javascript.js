  ...
  $(".content-lazyload").each(function(){
     ...
     <center class="pt-5">
       <blockquote class="twitter-tweet">
         <p lang="en" dir="ltr">
           Stop having a boring tuna, stop having a boring life. Yglesias
           on Slap Chop http://bit.ly/4p3DuR
           <a
             href="https://twitter.com/hashtag/slapchop?src=hash&amp;ref_src=twsrc%5Etfw"
             >#slapchop</a
           >
         </p>
         &mdash; Ari Melber (@AriMelber)
         <a
           href="https://twitter.com/AriMelber/status/7630419022?ref_src=twsrc%5Etfw"
           >January 11, 2010</a
         >
       </blockquote>
       <script
...
const PERSONAL_STATEMENT = "I am a highly motivated and organised individual, who demonstrates \
...
$(".personalIntroduction").get().forEach((e) => e.innerHTML = PERSONAL_STATEMENT);
...
$(window).scroll(() => {
  ...
  $(".productionYear").get().forEach((e) => e.innerHTML = PRODUCTION_YEAR);
  $(".phoneRepairExperience").get().forEach((e) => e.innerHTML = PHONE_REPAIR_EXPERIENCE);
  $(".personalIntroduction").get().forEach((e) => e.innerHTML = PERSONAL_STATEMENT);
